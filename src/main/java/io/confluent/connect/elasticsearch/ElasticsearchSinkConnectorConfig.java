...
public class ElasticsearchSinkConnectorConfig extends AbstractConfig {
  ...
  private static final String ROUTING_FIELD_NAME_CONFIG = "routing.field.name.config";
  private static final String ROUTING_FIELD_NAME_DOC = "Which field should be used for routing";
